...
import style from './ProductSelectorRedesign.module.scss';
...
function ProductSelectorRedesignComponent(
  props: TProductSelectorRedesignProps
) {
...
export const ProductSelectorRedesign = inject(
  STORE_IDS.LOAN_STORE,
  STORE_IDS.USER_STORE,
  STORE_IDS.PAGE_STORE,
  STORE_IDS.LOYALTY_STORE
)(observer(ProductSelectorRedesignComponent));
