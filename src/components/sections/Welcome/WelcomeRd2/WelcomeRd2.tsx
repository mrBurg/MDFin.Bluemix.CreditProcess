...
import style from './WelcomeRd2.module.scss';

import { TWelcomeRedesignProps } from './@types';
import { WithTag } from '@components/hocs';
import { ProductSelectorRd2 } from '@components/ProductSelector/ProductSelectorRd2';
import Image from 'next/image';
import classNames from 'classnames';

function WelcomeRd2(props: TWelcomeRedesignProps) {
